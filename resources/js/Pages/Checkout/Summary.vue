...
<template>
    ...
    <AuthenticatedLayout>
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Review Your Order</h1>
            ...
            <div class="mt-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
                ...
                <div class="lg:col-span-7">
                    <div class="rounded-2xl bg-white dark:bg-navy-900/60 shadow-sm border border-slate-100 dark:border-navy-800/60 overflow-hidden">
                        ...
                        >
                            <div class="flex items-center gap-3">
                                ...
                                <span class="rounded-full bg-brand-100 dark:bg-brand-900/50 px-2.5 py-0.5 text-sm font-medium text-brand-700 dark:text-brand-300">
                                    {{ cart.items.length }}
                                </span>
                            </div>
                            <svg
                    ...
                    <div class="mt-4 text-center">
                        <Link
                            ...
                            class="inline-flex items-center gap-1 text-sm font-medium text-brand-600 dark:text-brand-400 hover:text-brand-500 transition-colors"
                        >
                    ...
                    <div class="rounded-2xl bg-white dark:bg-navy-900/60 shadow-sm border border-slate-100 dark:border-navy-800/60 p-6 sticky top-24">
                        ...
                        >
                            <div
                                ...
                                class="mt-4 rounded-xl bg-red-50 dark:bg-red-900/20 p-4 border border-red-200 dark:border-red-800/60"
                            >
