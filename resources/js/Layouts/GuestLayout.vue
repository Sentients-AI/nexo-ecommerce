                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:gap-2 sm:ml-2">
                            ...
                            <Link
                                ...
                                class="px-4 py-2 rounded-lg text-sm font-semibold text-white bg-brand-500 hover:bg-brand-400 shadow-sm transition-all hover:shadow-md"
                            >
                                {{ t('nav.sign_up') }}
                            </Link>
                        </div>
                ...
                <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <ul class="mt-4 space-y-3">
                            <li>
                                <Link :href="localePath('/products')" class="text-sm text-slate-400 hover:text-white transition-colors">
                                    {{ t('footer.all_products') }}
                                </Link>
                            </li>
                            <li>
                                <Link :href="localePath('/products?featured=1')" class="text-sm text-slate-400 hover:text-white transition-colors">
                                    {{ t('footer.featured') }}
                                </Link>
                            </li>
                        </ul>
