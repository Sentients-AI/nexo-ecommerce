...
final class PromotionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (! Promotion::where('code', 'WELCOME10')->exists()) {
        ...
        if (! Promotion::where('code', 'SAVE15')->exists()) {
        ...
        if (! Promotion::where('code', 'SUMMER20')->exists()) {
        ...
        if (! Promotion::where('name', 'Flash Deal 5% Off')->exists()) {
        ...
        if (! Promotion::where('code', 'FIVEOFF')->exists()) {
        ...
        if (! Promotion::where('code', 'BLACKFRI15')->exists()) {
        ...
        if (! Promotion::where('code', 'HOLIDAY20')->exists()) {
